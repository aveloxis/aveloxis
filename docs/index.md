...
- **22 materialized views** — 20 8Knot-compatible analytics views plus the two supply-chain package views, rebuilt weekly; optional (`collection.materialized_views`)
