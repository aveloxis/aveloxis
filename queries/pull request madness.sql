            ...
            FROM
                ...
                aveloxis_data.pull_requests LEFT OUTER JOIN ( 
                    ...
                    FROM  aveloxis_data.pull_requests 
                                            LEFT OUTER JOIN aveloxis_data.pull_request_events on aveloxis_data.pull_requests.pull_request_id = aveloxis_data.pull_request_events.pull_request_id 
                                            JOIN aveloxis_data.repos on repos.repo_id = pull_requests.repo_id 
                                            LEFT OUTER JOIN aveloxis_data.pull_request_message_ref on pull_requests.pull_request_id = pull_request_message_ref.pull_request_id
                                            LEFT OUTER JOIN aveloxis_data.messages on pull_request_message_ref.msg_id = aveloxis_data.messages.msg_id
                    --WHERE repos.repo_id = {repo_id} 
                ...
                LEFT JOIN (
                    SELECT pull_request_commits.pull_request_id, count(DISTINCT pr_cmt_sha) AS commit_count                                
                                            FROM aveloxis_data.pull_request_commits, aveloxis_data.pull_requests, aveloxis_data.pull_request_meta
                ...
                LEFT JOIN (
                    ...
                    FROM aveloxis_data.pull_requests, aveloxis_data.pull_request_meta
                ...
                LEFT JOIN (
                    ...
                    FROM aveloxis_data.pull_request_commits, aveloxis_data.commits, aveloxis_data.pull_requests, aveloxis_data.pull_request_meta
