...
Expect a short stream of `migration step ok` log lines. The full schema (146 tables, 20 materialized views, 50+ indexes) lands in two passes — DDL then matview creation.
